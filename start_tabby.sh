...
for v in EXL3_DRAFT_CONFIDENCE EXL3_GR_INT8 EXL3_MOE_COOP_WIDE EXL3_INT8_GEMV \
         ...
         EXL3_HIST_STASH EXL3_CONV_CKPT EXL3_CONV_CKPT_MIN EXL3_CONV_CKPT_MAX EXL3_LASTPAGE EXL3_DECODE_STATS EXL3_SPEC_SAMPLE EXL3_TRIAL_AB \
         TABBY_TOOLCALL_ARGS TABBY_TOOL_MARKERS TABBY_EFFORT_ALIAS; do
